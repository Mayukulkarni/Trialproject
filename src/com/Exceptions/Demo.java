...
public class Demo
{
	...
	public static void main(String[] args)
	{
		...
		catch (Exception e)
		{
			...
			System.out.println(" please print the value in renge");
		}
...
You can catch different exceptions in different catch blocks. When an exception occurs in try block,
...
/*Rules:
	...
	Any code contained in a finally block always executes, regardless of whether an exception occurs, 
	except when the program exits early from a try block by calling the System.exit() method
